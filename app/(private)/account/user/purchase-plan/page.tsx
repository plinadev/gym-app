      ...
      <div className="grid grid-cols-4 gap-7 mt-7">
        {plans.map((plan: any) => {
          ...
          return (
            <div
              key={plan.id}
              className="flex flex-col justify-between p-5 border border-stone-300 rounded-lg"
            >
              <div className="flex flex-col gap-2 mt-5">
                ...
                <ul className="flex flex-col gap-1">
                  {plan.features.map((feature: any, index: number) => (
                    <li key={index} className="text-xs text-stone-600">
                      {feature}
                    </li>
                  ))}
                </ul>
              ...
              <div className="flex flex-col gap-5 mt-5">
                ...
                <select
                  className="border border-stone-300 rounded p-2 text-sm"
                  onChange={(e) => {
                ...
                >
                  ...
                  {paymentPlans.map((payment) => (
                    <option key={payment.key} value={payment.price}>
